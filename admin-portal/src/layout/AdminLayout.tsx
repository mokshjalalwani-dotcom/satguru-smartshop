...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-[#0b0f19] text-white relative overflow-hidden">
      {/* Background Blobs */}
      <div className="absolute -top-40 -right-40 w-[520px] h-[520px] bg-indigo-600/20 rounded-full filter blur-[120px] pointer-events-none" />
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        <header className="h-16 border-b border-white/5 bg-xcard/30 backdrop-blur-xl flex items-center justify-between px-8 relative z-20">
          <div className="flex items-center gap-4">
            ...
            <div className="px-3 py-1 bg-xbrand/10 border border-xbrand/20 rounded-lg text-[10px] font-bold text-xbrand uppercase tracking-tighter">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-xbrand to-indigo-600 p-0.5 shadow-[0_4px_20px_rgba(0,242,254,0.2)]">
                <div className="w-full h-full bg-[#0b0f19] rounded-[10px] flex items-center justify-center">
                  <UserIcon size={20} className="text-xbrand" />
                </div>
              </div>
            </div>
            <button 
